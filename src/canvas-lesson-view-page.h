...
CanvasMessageType canvas_lesson_view_page_get_message (CanvasLessonViewPage* page);
void canvas_lesson_view_page_set_message (CanvasLessonViewPage* page, CanvasMessageType message);
const gchar* canvas_lesson_view_page_get_explanation (CanvasLessonViewPage* page);
void canvas_lesson_view_page_set_explanation (CanvasLessonViewPage* page, const gchar* explanation);
