...
#ifndef _CANVAS_LESSON_TEST_ORDER_PAGE_H_
#define _CANVAS_LESSON_TEST_ORDER_PAGE_H_

#include <glib-object.h>

G_BEGIN_DECLS

#define CANVAS_TYPE_LESSON_TEST_ORDER_PAGE             (canvas_lesson_test_order_page_get_type ())
#define CANVAS_LESSON_TEST_ORDER_PAGE(obj)             (G_TYPE_CHECK_INSTANCE_CAST ((obj), CANVAS_TYPE_LESSON_TEST_ORDER_PAGE, CanvasLessonTestOrderPage))
#define CANVAS_LESSON_TEST_ORDER_PAGE_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST ((klass), CANVAS_TYPE_LESSON_TEST_ORDER_PAGE, CanvasLessonTestOrderPageClass))
#define CANVAS_IS_LESSON_TEST_ORDER_PAGE(obj)          (G_TYPE_CHECK_INSTANCE_TYPE ((obj), CANVAS_TYPE_LESSON_TEST_ORDER_PAGE))
...
struct _CanvasLessonTestOrderPageClass
{
...
#endif /* _CANVAS_LESSON_TEST_ORDER_PAGE_H_ */
