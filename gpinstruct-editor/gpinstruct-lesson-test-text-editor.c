...
update_questions_tree_view (GPInstructLessonTestTextEditor *editor)
{
	...
	GList *questions = gpinstruct_lesson_test_text_get_questions (editor->priv->test);
                              ...
                              gpointer   user_data)
{
	...
	gpinstruct_lesson_test_text_add_question (editor->priv->test, question);
                                 ...
                                 gpointer   user_data)
{
	...
	if (gtk_tree_selection_get_selected (selection, NULL, &iter))
	{
		...
		gpinstruct_lesson_test_text_remove_question (editor->priv->test, gtk_tree_path_get_indices (path)[0]);
